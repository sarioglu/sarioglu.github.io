...
var Card = function Card(_ref) {
  ...
  return __jsx("div", {
    className: "flex sm:block rounded shadow overflow-hidden transition duration-200 ease-in-out hover:shadow-xl hover:scale-105 mb-8 sm:mb-0",
    __source: {
    ...
    className: "w-8 h-8 lg:w-full lg:h-64 flex justify-center items-center",
    style: {
...
//# sourceMappingURL=index.js.89744834e7b61ee3562d.hot-update.js.map