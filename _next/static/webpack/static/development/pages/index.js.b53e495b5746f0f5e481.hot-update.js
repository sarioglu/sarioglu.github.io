...
var Card = function Card(_ref) {
  ...
  return __jsx("div", {
    ...
    className: "w-10 h-10 rounded-full mx-4 lg:w-full lg:h-64 lg:rounded-none lg:mx-0 flex justify-center items-center",
    style: {
    ...
    className: "px-3 lg:px-6 pt-4 pb-2",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24
    },
    ...
    className: "font-bold text-gray-900 text-sm lg:text-base lg:mb-2",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25
    },
    ...
    className: "flex flex-wrap justify-start -mx-1 lg:-mx-2",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28
    },
...
//# sourceMappingURL=index.js.b53e495b5746f0f5e481.hot-update.js.map