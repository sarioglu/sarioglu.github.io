...
var Card = function Card(_ref) {
  ...
  return __jsx("div", {
    className: "flex lg:block rounded shadow overflow-hidden transition duration-200 ease-in-out hover:shadow-xl hover:scale-105 mb-8 sm:mb-0",
    __source: {
    ...
    src: logo,
    alt: "project-logo",
    className: "mx-auto w-8 h-8 lg:w-3/6 lg:h-auto rounded-full lg:rounded-none",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19
    },
    ...
    className: "font-bold text-gray-900 sm:text-xl xl:text-base mb-2",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22
    },
    ...
    return __jsx("div", {
      key: keyword,
      className: "inline-block bg-gray-200 rounded-full px-3 py-1 text-xs font-medium text-gray-800 m-1",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 27
      },
...
//# sourceMappingURL=index.js.b73d73104cd2a1622660.hot-update.js.map