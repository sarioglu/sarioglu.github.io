...
var Card = function Card(_ref) {
  ...
  return __jsx("div", {
    ...
    className: "font-bold text-gray-900 text-sm lg:text-base mb-2",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25
    },
    ...
    return __jsx("div", {
      key: keyword,
      className: "inline-block lg:bg-gray-200 rounded-full lg:px-3 lg:py-1 text-xs font-medium text-gray-800 mr-1",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 30
      },
...
//# sourceMappingURL=index.js.f4a7968ff229617e96be.hot-update.js.map